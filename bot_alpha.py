...
# Your bot's token (keep it private!)
...
class MyClient(discord.Client):
    def __init__(self, intents):
        super().__init__(intents=intents)  # Pass intents to the parent class
        self.channel = None
        self.new_messages = []
        self.new_message_event = asyncio.Event()
        self.aes_key1 = Gen_aes.generate_aes_key(16)  # Generate AES key
        self.aes_key = prepare_key(self.aes_key1)
        print(colorama.Fore.GREEN + "AES Key (raw):", self.aes_key)
